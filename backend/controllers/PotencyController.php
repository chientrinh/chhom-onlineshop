...
use common\models\SearchPotency;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PotencyController implements the CRUD actions for RemedyPotency model.
 *
 * $URL: https://tarax.toyouke.com/svn/MALL/backend/controllers/PotencyController.php $
 * $Id: PotencyController.php 1157 2015-07-15 13:01:02Z mori $
 */

class PotencyController extends BaseController
{
