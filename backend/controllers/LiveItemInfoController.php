...
use common\models\LiveItemInfoSearch;
 ...
 *
 * $URL: https://tarax.toyouke.com/svn/MALL/backend/controllers/LiveItemInfoController.php $
 * $Id: LiveItemInfoController.php 2286 2016-03-21 06:11:00Z mori $
 */
class LiveItemInfoController extends BaseController
{
    public function beforeAction($action)
    {
        ...
        $this->view->params['breadcrumbs'][] = ['label'=>'ライブ配信追加情報_商品リンク','url'=>['index']];
    ...
    {
        $searchModel = new LiveItemInfoSearch();
    ...
    public function actionUpdate($id)
    {
        ...
        if($param)
        {
            ...
            foreach ($param['LiveItemInfo'] as $key => $value) {
                $model->$key = $value;                
            }
            // $model->load($param);
    ...
    {
        if (($model = LiveItemInfo::findOne($id)) !== null) {
            return $model;
        } else {
