...
/**
 * $URL: https://tarax.toyouke.com/svn/MALL/backend/views/inventory/view.php $
 * $Id: view.php 3268 2017-04-21 01:45:07Z kawai $
 *
    ...
    'attributes' => [
        [
            ...
            'value'     => $model->status->name
                       . Html::a('<i class="glyphicon glyphicon-print"></i>',['print','id'=>$model->inventory_id,'format'=>'html'],['class'=>'pull-right btn btn-default', 'title'=>'原価集計を表示します'])
                       . Html::a('<i class="glyphicon glyphicon-download-alt"></i>',['print','id'=>$model->inventory_id,'format'=>'csv'],['class'=>'pull-right btn ' . ($model->isApproved() ? 'btn-warning':'btn-default'), 'title'=>'原価集計をダウンロードします'])
        ],
        [
            'attribute' => 'branch_id',
