...
<h3>　サブカテゴリー<?= $campaignDetails->isNewRecord ? "登録" : "更新"; ?></h3>
...
<div class="col-md-7">
    ...
    <div class="form-group">
        ...
        <?= $form->field($campaignDetails, 'subcategory_id')
    ...
    <div class="pull-right">
        <?= Html::a('戻る', ['view', 'id' => $campaign->campaign_id, 'target' => 'viewSubCategory', ], ['class' => 'btn btn-danger update']
                ) ?>
    </div>
