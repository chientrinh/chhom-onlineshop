<?php
/**
 * $URL: https://tarax.toyouke.com/svn/MALL/backend/modules/casher/views/default/_trose.php $
 * $Id: _trose.php 2908 2016-10-02 01:52:37Z mori $
 *
 * $searchModel  Model
...
$categories = ArrayHelper::map(Category::find()->andWhere(['category_id' => 16])->all(), 'category_id', 'name');
?>
