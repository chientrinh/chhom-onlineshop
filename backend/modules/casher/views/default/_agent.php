<?php
/**
 * $URL: https://tarax.toyouke.com/svn/MALL/backend/modules/casher/views/default/_agent.php $
...
$categories = ArrayHelper::map(Subcategory::find()->andWhere(['subcategory_id' => Subcategory::PKEY_ONLY_HE])->all(), 'subcategory_id', 'name');
?>
