 ...
 * $Id: Category.php 4248 2020-04-24 16:29:45Z mori $
 *
...
class Category extends \yii\db\ActiveRecord
{
    ...
    const SODAN       = 8;
    const LIVE       = 24; // ライブ配信 2020/04/21 : kawai
    const LIVE_OPTION = 26; // ライブ配信オプション 2021/04/15 : kawai
...
class CategoryQuery extends \yii\db\ActiveQuery
{
    ...
    {
        return $this->andWHere(['category_id' => [Category::BOOK]]);
    }
}
