...
class Campaign extends \yii\db\ActiveRecord
{
    ...
    public $shippings = [0 => "通常", 1 => "送料無料"];
    public $preorders = [0 => "通常", 1 => "事前注文受付"];
    ...
    public function rules()
    {
        return [
            ...
            [['streaming_id','free_shipping1','free_shipping2','pre_order'], 'default', 'value' => null],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'branch'           => '拠点',
            'streaming_id'     => '配信ID',
            'free_shipping1'     => '送料無料（豊受）',
            'free_shipping2'     => '送料無料（熱海）',
            'pre_order'     => '事前注文受付',
            'create_by'        => '作成者',
            'create_date'      => '作成日時',
            'update_by'        => '更新者',
    ...
    public function getFreeShipping1()
    {
        return $this->free_shipping1;
    }
    public function setFreeShipping1($val)
    {
        return $this->free_shipping1 = $val;
    }
    public function getFreeShipping2()
    {
        return $this->free_shipping2;
    }
    public function setFreeShipping2($val)
    {
        return $this->free_shipping2 = $val;
    }
    public function getPreOrder()
    {
        return $this->pre_order;
    }
    public function setPreOrder($val)
    {
        return $this->pre_order = $val;
    }
