 ...
 * $Id: Customer.php 3001 2016-10-22 05:36:26Z mori $
 *
    ...
    public function rules()
    {
        ...
        return [
            ...
            ['email', 'required', 'when' => function($model){
                return ('app-frontend' == Yii::$app->id || 'echom-frontend' == Yii::$app->id) &&
...
$time_start = microtime(true);
        ...
        if (time() >= strtotime('2019-06-01 00:00:00')) {
            ...
            $oneYear_purchases = Purchase::find()
                ...
                ->andWhere(Purchase::tableName().'.status IN (' . PurchaseStatus::PKEY_INIT . ',' . PurchaseStatus::PKEY_PAYING . ',' . PurchaseStatus::PKEY_DONE . ')')
