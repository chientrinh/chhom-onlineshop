<?php
namespace common\widgets\doc\stock;

/**
 * $URL: https://tarax.toyouke.com/svn/MALL/common/widgets/doc/stock/ThresholdStockCsv.php $
 * $Id: ThresholdStockCsv.php 2621 2016-06-24 09:57:25Z mori $
 */

use Yii;
use \common\models\Stock;

class ThresholdStockCsv extends \yii\base\Widget
{
    /* @var purchase_id to find Stock Model,
    ...
    private function setHeders()
    {
        $headers = Stock::attributeLabels();
