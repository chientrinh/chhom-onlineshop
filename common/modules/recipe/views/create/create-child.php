...
$customer_parent = \common\models\Customer::findOne($parent_id);
?>
<script>
...
<div class="cart-view">
  <div class="col-md-9">
    ...
    <div class="form-group">
        ...
        <?php endif ?>
        <?= Html::a('戻る', ['/recipe/create/search', 'target' => 'client', 'client_id' => $parent_id, 'mcode' => $customer_parent->membercode->code], ['class' => 'btn btn-danger']) ?>
    </div><!--form-group-->
    <?php $form->end(); ?>
  </div><!--col-md-12-->
  </div><!--row column01-->
