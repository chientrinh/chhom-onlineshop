...
namespace common\modules\sodan\models;
 ...
 * 質問票を表現するための Model
 *
 * $URL: https://tarax.toyouke.com/svn/MALL/common/modules/sodan/models/Questionnaire.php $
 * $Id: Questionnaire.php 3851 2018-04-24 09:07:27Z mori $
 */

class Questionnaire extends \yii\base\Model
{
    public $occupation;
    public $bodyWeight;
    public $bodyHeight;
    public $birthWeight;
    public $birthPlace;
    public $complaintBrief;
    public $complaintDetail;
    public $particulars;
    public $allergy;
    public $vaccine;
    public $historyOfMother;
    public $historyOfFather;
    public $historyOfMaternalGrandmother;
    public $historyOfMaternalGrandfather;
    public $historyOfPaternalGrandmother;
    public $historyOfPaternalGrandfather;
    public $favoriteFood;
    public $dislikeFood;
    public $favoriteLandscape;
    public $physicalExercise;
    public $physicalExerciseWhy;
    public $physicalExerciseWhat;
    public $tightCloth;
    public $sunLight;
    public $sunLightSpecify;
    public $moonLight;
    public $moonLightSpecify;
    public $sleepDuration;
    public $sleepQuality;
    public $sleepQualityWhy;
    public $sleepWakeup;
    public $dream;
    public $dreamWhat;
    public $perspiration;
    public $perspirationHow;
    public $hydration;
    public $hydrationHow;
    public $temperature;
    public $temperetureSpecify;
    public $sensation;
    public $episode;
    public $phobia;
    public $childhoodPersonality;
    public $presentPersonality;
    public $repetition;
    public $stressedWhen;
    public $worryAbout;
    public $preciousTopic;
    public $toDoWhenDeppressed;
    public $hobby;
    public $wantToDo;
    public $alcohol;
    public $tobaco;
    public $weep;
    public $mentalTendency;
    public $musicAffected;
    public $musicAffectedWhy;
    public $musicPreference;
    public $bathPreference;
    public $bathPreferenceWhy;
    public $memory;
    public $productivity;
    public $productivityWhy;
    public $tidy;
    public $tidyWhy;
    public $specialNote;
    public $personalStory;
    ...
    public function attributeLabels()
    {
        return [
            ...
            'familyMember'           => '家族構成',
            'occupation'             => '職業',
            'complaintBrief'         => '主訴（身体的・精神的に困っていることなどをご記入下さい）一番つらい順番にお書きください。',
            'complaintDetail'        => '具体的内容（いつから・どのような経過を経てきたかなどをご記入下さい）',
            'pastTherapy'            => '今までに受けた治療・セラピー',
            'pastMedication'         => '今までに内服・外用していた薬、今でも使用している薬（他、サプリメントなど）',
            'locationHead'           => '頭',
            'locationFace'           => '顔',
            'locationEar'            => '耳',
            'locationEye'            => '目',
            ...
            'locationKidney'         => '',
            'locationStomach'        => '',
            'locationSmallIntestine' => '',
            'locationLargeIntestine' => '',
            'locationBack'           => '',
            'locationLoin'           => '',
            'locationBladder'        => '',
            'locationAnus'           => '',
            ...
            'historyOfMother'        => '',
            'historyOfFather'        => '',
            'historyOfMaternalGrandmother' => '',
            'historyOfMaternalGrandfather' => '',
            'historyOfPaternalGrandmother' => '',
            'historyOfPaternalGrandfather' => '',
            'favoriteFood'      => '',
            'dislikeFood'       => '',
            'favoriteLandscape' => '',
            'physicalExercise'  => '',
            'physicalExerciseWhy' => '',
            'physicalExerciseWhat' => '',
            'tightCloth' => '',
            'sunLight' => '',
            'sunLightSpecify' => '',
            'moonLight' => '',
