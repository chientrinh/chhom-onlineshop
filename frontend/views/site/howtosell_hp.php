...
/**
 * $URL: https://tarax.toyouke.com/svn/MALL/frontend/views/site/howtosell_hp.php $
 * $Id: howtosell_hp.php 3760 2017-11-17 10:24:42Z naito $
 *
 * @var $this \yii\web\View
 */

$title = "ホメオパシー出版書籍取扱店様用売上入力ガイド";
...
　　<p><?= Html::a('①豊受モールにログイン',['howtosell_he','#'=>'login'],['class'=>'btn btn-big btn-success'])?>　<font size = 4 color=#008000>&#10148; </font>
       <?= Html::a('②マイページより、取扱店様専用売上入力へ',['howtosell_he','#'=>'mypage'],['class'=>'btn btn-big btn-success'])?>　<font size = 4 color=#008000>&#10148; </font>
    ...
    <p><br><br></p>
    <h3 id="mypage">②マイページより、取扱店様専用売上入力を選択 </h3>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_01.jpg') ?></p>
    <p><br><br></p>
    <h3 id="kihyo">③起票するをクリック</h3>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_02.jpg') ?></p>
    <h3 id="syohin">④商品を入力</h3> 
    <p>※商品バーコードを読み取ることで、商品が選択可能です。バーコードリーダーを使⽤することで、業務の効率化を図ることができます。 </p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_03.jpg') ?></p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_04.jpg') ?></p>
    <h3 id="customer">⑤お客様を入力</h3>
    <p>お客様に「豊受オーガニクスモール会員証」を提示していただくと、会員証バーコードで特定が可能です。</p>
    <p>お客様の電話番号でも検索ができます。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_05.jpg') ?></p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_06.jpg') ?></p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_07.jpg') ?></p>
    <p><br><br></p>
    <h3 id="money">⑥お預かりを入力</h3>
    <p>お⽀払時に 豊受モールポイントを使っていただくことができます。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_08.jpg') ?></p>
    <p><br><br></p>
    <h3 id="finish">⑦確定</h3> 
    <p>確定した時点で、お客様のランクに応じた豊受モールポイントが⾃動計算され、付与されます。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_09.jpg') ?></p>
    
    <p>元の画面に戻るには、「次のお買い物」をクリックします。「印刷する」でレシート印刷ができます。<br>
        レシートプリンターを導入していただくと、レシート用紙に印刷ができます。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_10.jpg') ?></p>
    <p>履歴を見る場合は、履歴をクリックします。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_11.jpg') ?></p>
    <p>売上伝票を修正、キャンセルする場合は、伝票NOをクリックします。</p>
    <p align="center"><?= Html::img('@web/img/how_to_sell_hp_12.jpg') ?></p>
    <p><br><br></p>
