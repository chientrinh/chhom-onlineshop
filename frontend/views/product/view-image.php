...
$this->params['breadcrumbs'][] = ['label' => $model->company->name, 'url' => [sprintf('/%s',$model->company->key)]];

if($sub = $model->getSubcategories()->one())
{
    $this->params['breadcrumbs'][] = ['label' => $sub->fullname, 'url' => [$model->company->key.'/subcategory','id'=>$sub->subcategory_id]];
}
