...
/**
 * $URL: https://tarax.toyouke.com/svn/MALL/frontend/widgets/views/_item.php $
 * $Id: _item.php 4110 2019-02-06 04:11:15Z kawai $
 */
...
<div class="col-md-4">
  ...
  <?php if($c = $model->category): ?>
      <p>
      <?= Html::a($c->seller->name,['/'.$c->seller->key],['class'=>'small','style'=>'font-size:50%;color:#999']) ?>
      </p>
  <?php endif ?>
  <p><?= Html::a($modelName, $url) ?></p>
  <p class="Feature"><?= $model->excerpt ?></p>
  <p class="Price"><?= $modelPrice ?></p>
  <p>
      <?= $this->render('__link',['model'=>$model,'remedyStock'=>$remedyStock]) ?>
      
      <a class="btn btn-info" href="<?= $url ?>">もっと見る</a>
  </p>
  </div>
</div>
<?php endif; ?>