  ...
  <div class="col-md-4">
    <h3>
      <div class="center_img thum_box thum_img">
        <div>
          <span style="position: absolute;right: 0;padding: 5px 10px;font-size: 20px; font-weight: bold; background: #d9e6ed;">
            <?php if (is_null($model->product->client_id)) : ?>
              ...
            <?php elseif ($model->product->client_id == Yii::$app->user->id) : ?>
