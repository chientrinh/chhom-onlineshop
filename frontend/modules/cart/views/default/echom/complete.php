...
$watch_url = $purchase->payment->payment_id == \common\models\Payment::PKEY_CREDIT_CARD ? $result['watch_url'].'/'.$purchase->purchase_id : \common\models\Streaming::find()->one()->streaming_url;
...
<p><strong>※ライブ配信の視聴URLなどメールでお送りしていますが、こちらでもご確認の上、情報を紛失しないようご注意ください</strong></p>
